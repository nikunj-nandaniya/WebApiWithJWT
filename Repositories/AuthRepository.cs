...
namespace WebAPIwithJWT.Repositories
{
    public class AuthRepository : IAuthRepository
    {
        ...
        {
            if (await _appDbContext.Users.AnyAsync(user => user.Email.ToLower().Equals(email.ToLower())))
            {
                return true;
            }
            return false;
        ...
        public async Task<ServiceResponse<string>> Login(string email, string password)
        {
            ...
            var user = await _appDbContext.Users.FirstOrDefaultAsync(user => user.Email.ToLower().Equals(email.ToLower()));
            if (user == null)
            {
